...
import { api, artwork, jf, timeLabel, youtubeId } from '../api';
...
export default function MediaDetails({item, onClose, onPlay}) {
  ...
  const [history, setHistory] = useState([]), [error, setError] = useState(''), [busy, setBusy] = useState(false), [trailerId, setTrailerId] = useState(null);
  useFocusScope(root);
  useEffect(() => {
