...
class Settings(BaseSettings):
    ...
    # Optional: generated on first run and persisted under data_dir if unset, so no
    # secret needs to be supplied via the environment. See services/secret_store.py.
